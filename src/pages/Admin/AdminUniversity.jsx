...
import { TableNav, Table, UniToolbar } from '@/components/Table';
...
const AdminUniversity = () => {
  ...
  return (
    <section className="max-xs:p-2 flex h-[calc(100%-80px)] flex-col p-10 pb-2 max-sm:p-5">
      <h1 className="mb-4 text-xl font-bold">University Management</h1>
      <div className="flex min-h-0 flex-col overflow-hidden bg-white dark:bg-gray-800">
        <UniToolbar data={tableData} setTableData={setTableDataCallback} />
