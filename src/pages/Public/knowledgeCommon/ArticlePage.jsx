                    ...
                    <div className="h-full w-[265px] rounded-[7px] border-[2px] flex p-[5px]  ">
                        ...
                        <div className="h-full w-[180px] ">
                            ...
                            <div className="h-[65px] w-[full] mt-[8px]">
                                ...
                                <div className="h-[50px] w-[180px] bg-[#982B35] hover:bg-[#b63340] transition-colors delay-200 rounded-[6px] flex justify-center items-center text-[10px] font-semibold text-[#fff] cursor-pointer">Download</div>
                            </div>
                        </div>
                    </div>
                </div>
