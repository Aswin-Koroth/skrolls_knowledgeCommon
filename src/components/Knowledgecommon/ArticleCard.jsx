...
const ArticleCard = ({ArticleTitle,ArticleTopic,Category,PublishedDate,AuthorImage,AuthorName, onClick}) => {
  return (
    <div className='h-[220px] w-[1000px] bg-white rounded-[14px] flex justify-between items-center overflow-hidden cursor-pointer hover:shadow-lg transition-all delay-200' onClick={onClick}>
        <div className="h-[210px] w-[700px] flex justify-center items-center">
            <div className="h-[190px] w-[680px]">
                ...
                <div className="h-[25px] w-[400px] mt-[15px] flex justify-start">
                    ...
                    <div className="h-[22px] text-[12px] text-[#F36760] border-[2px] border-[#F36760] ml-[10px] px-[3px]">{Category}</div>
                ...
                <div className="h-[20px] w-[200px] flex justify-start items-center gap-[3px] ">
        ...
        <div className="h-[210px] w-[150px] flex justify-center items-center" >
            <div className="h-[190px] w-[110px] bg-[#F9FAFB] rounded-[6px] flex flex-col justify-center items-center">
                ...
                <div className="h-[25px] w-[100px] bg-[#F36760]  hover:bg-[#ea625b] transition-colors delay-200 rounded-[6px] mt-[5px] flex justify-between items-center">
