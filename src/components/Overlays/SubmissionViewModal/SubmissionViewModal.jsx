    ...
    <>
      ...
      >
        ...
        <TextContainer>
          ...
          paradigms. The research highlights the importance of adaptive
          strategies for stakeholders to harness the benefits while mitigating
          the challenges posed by rapid technological changes. This abstract
          serves as a placeholder, providing a concise overview of the
          anticipated scope and impact of the forthcoming journal article.
        </TextContainer>
        <H1>Authors</H1>
        <TextContainer>
          <Button className="dark:text-text bg-black font-semibold text-white dark:bg-white">
            A. Majeed
          </Button>
          <Button className="dark:text-text bg-black font-semibold text-white dark:bg-white">
            Anurag T K
        ...
        <section className="border-1 sticky bottom-0 flex gap-2 border-t-2 bg-bg-secondary py-3 dark:border-gray-800 dark:bg-gray-900 max-sm:gap-5">
          ...
          <AlertDialog>
            ...
            <DeleteConfirm
              dialogType="Reject"
              description="Handheld augmented reality indoor navigation with actiity-based instructions"
              subType="Article"
            />
          </AlertDialog>
